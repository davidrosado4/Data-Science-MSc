...
class IDFeatures:
    ...
    def build_features(self):
        ...
        for sequence in self.dataset.seq_list:
            in_features, tra_features, fi_features, em_features = self.get_sequence_features(sequence)
            self.feature_list.append([in_features, tra_features, fi_features, em_features])
        self.add_features = False
